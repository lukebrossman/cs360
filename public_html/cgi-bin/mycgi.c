...
main(int argc, char *argv[]) 
{
  ...
  {
    printf("mkdir recieved");
    mkdir(entry[1].value, 0777);
  }
  if (entry[0].value == "rmdir")
  {
    rmdir(entry[1].value);
    printf("rmdir recieved");
  }
  ...
  *****************************************************************/
  ...
  printf("<FORM METHOD=\"POST\" ACTION=\"http://cs360.eecs.wsu.edu/~brossman/cgi-bin/mycgi.bin\">");
